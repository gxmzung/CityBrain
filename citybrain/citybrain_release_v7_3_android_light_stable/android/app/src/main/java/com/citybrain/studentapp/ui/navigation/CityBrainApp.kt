...
import com.citybrain.studentapp.ui.screens.my.MyScreen
...
fun CityBrainApp(repository: CityBrainRepository) {
    ...
    Scaffold(
        ...
        NavHost(navController = navController, startDestination = "home", modifier = Modifier.padding(innerPadding)) {
            composable("home") { HomeScreen(uiState = uiState, onRefresh = vm::refresh) }
            composable("live") { LiveScreen(uiState = uiState) }
