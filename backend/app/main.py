...
from app.routes import student, admin, kiosk, roadmap, auth, ops, jarvis, vision, vision_page, vision_report, vision_history, vision_auto_logging, vision_pilot_report
...
app.include_router(vision_auto_logging.router)
app.include_router(vision_pilot_report.router)
